<template>
  <section>
    <div class="page-header">
      <div><div class="eyebrow">INTEGRATION MONITOR</div><h2>Gateway status</h2><p>Services represented by the DVA gateway and its connected processing path.</p></div>
...
const serviceDefinitions = [
  { name: 'DVA API gateway', endpoint: '/vla', probe: '/api/vla', icon: 'fa-route' },
  { name: 'Evaluation processing', endpoint: '/info/requests', probe: '/api/info/requests', icon: 'fa-microchip' },
  { name: 'Credential service', endpoint: '/info/credentials', probe: '/api/info/credentials', icon: 'fa-certificate' },
  { name: 'Event transport', endpoint: '/info/presentations', probe: '/api/info/presentations', icon: 'fa-wave-square' }
]
