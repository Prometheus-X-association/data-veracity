  ...
  <section>
    <div class="hero-row">
      <div>
        ...
        <p class="lede">Monitor evaluation requests, issued attestations, and verification results across the DVA services.</p>
      </div>
...
const serviceDefinitions = [
  { name: 'DVA API', description: 'Evaluation request history', probe: dashboardEndpoints.requests, icon: 'fa-route' },
  { name: 'VLA Manager API', description: 'VLA definitions and templates', probe: dashboardEndpoints.vlas, icon: 'fa-file-contract' },
  { name: 'VC Manager', description: 'Issued attestation audit', probe: dashboardEndpoints.credentials, icon: 'fa-certificate' },
  { name: 'VC verification', description: 'Attestation verification audit', probe: dashboardEndpoints.verifications, icon: 'fa-user-shield' }
]
...
async function loadRequests () {
  ...
  try {
    const [response, vlaResponse] = await Promise.all([axios.get(dashboardEndpoints.requests), axios.get(dashboardEndpoints.vlas)])
